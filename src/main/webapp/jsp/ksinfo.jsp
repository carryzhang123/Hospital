...
<FORM onsubmit="return ck()" method=post name=f1 action="/Demo/tms?ac=ghadd">
    ...
    <TABLE border=0 cellSpacing=0 cellPadding=0 width=720 align=center>
        ...
        <TR>
            <TD class=lfont height=33 align=middle><B>科室信息</B></TD>
        </TR>
        <TR>
            <TD align=middle>
                            ...
                            <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" height=130>
                                ...
                                <TR>
                                    <TD height=40 width="15%" align=right>
                                        <P>科室简介： </P></TD>
                                    <TD height=40 align="left"><%=map.get("remark") %>
                                    </TD>
                                </TR>
                                <TR>
                                    ...
                                    <TD height=40>
                                        <table width="100%" border="0">
                                            <tr>
                                                    <%ArrayList<HashMap> yslist = (ArrayList<HashMap>)dao.select("select * from sysuser where ks='"+id+"'");
                	if(yslist.size()>0){
                		int i=0;
