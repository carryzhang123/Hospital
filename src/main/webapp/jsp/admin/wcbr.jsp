...
-->
  ...
  HashMap admin = (HashMap)session.getAttribute("admin"); 
	 String sql = "select * from yy where 1=1 and ysid='"+admin.get("id")+"' and status='完成' ";
	 String url = "/Demo/admin/wcbr.jsp?1=1";
	...
	if(!stime.equals(""))
	 {
	 sql+=" and (yytime >= '"+stime+"')";
	 url+="&stime="+stime;
	 }if(!etime.equals(""))
	 {
	 sql+=" and (yytime <= '"+etime+"')";
	 url+="&etime="+etime;
	 }
	 sql+=" order by id desc";
%>
  <body>
  <form action="admin/wcbr.jsp?f=f" method="post">
  ...
  <tr>
    ...
    <th colspan="8"><span class="STYLE1">
