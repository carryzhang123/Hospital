...
%>
  <body>
  <form action="admin/bryy.jsp?f=f" method="post">
...
com.hosp.dao.commOper("delete from yy where id="+did);
   ...
   ArrayList<HashMap> nlist=(ArrayList)bean.getCollection();
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a href="admin/bryy.jsp?did=<%=mstu.get("id") %>">删除</a></span></div></td>
      </tr>
      <%} %>
      <tr>
