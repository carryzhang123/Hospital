...
<frameset rows="60,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset rows="*" cols="188,*" framespacing="0" frameborder="no" border="0">
    <frame src="admin/left.jsp" name="leftFrame" scrolling="No" noresize="noresize" id="leftFrame" />
    <frameset rows="73,*" cols="*">
      <frame src="admin/right_top.jsp" name="mainFrame" id="mainFrame" />
      <%HashMap admin = (HashMap)session.getAttribute("admin"); 
      if(admin.get("utype").equals("管理员")){
       %>
      <frame src="admin/sysuser.jsp" name="m"/>
      <%}else{ %>
      <frame src="admin/yybr.jsp" name="m"/>
      <%} %>
    </frameset>
  </frameset>
</frameset>
