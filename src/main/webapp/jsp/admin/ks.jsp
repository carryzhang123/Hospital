...
-->
  ...
  <%CommDAO java.com.hosp.dao = new CommDAO();
	 String sql = "select * from ks where 1=1 and delstatus=0";
	 String url = "/Demo/admin/ks.jsp?1=1";
...
%>
  <body>
  <form action="admin/ks.jsp?f=f" method="post">
            ...
            <tr>
              ...
              <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="admin/ksadd.jsp">新增</a></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
  ...
  <tr>
   ...
   if(did!=null)
   {
com.hosp.dao.commOper("update  ks set delstatus='1' where id="+did);
   }
   ...
   ArrayList<HashMap> nlist=(ArrayList)bean.getCollection();
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a href="admin/ksedit.jsp?id=<%=mstu.get("id") %>">修改</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="admin/ks.jsp?did=<%=mstu.get("id") %>">删除</a></span></div></td>
      </tr>
      <%} %>
      <tr>
